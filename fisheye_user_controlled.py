...
if __name__ == "__main__":
    ...
    for file_id in target_array: 
        ...
        if original:
            ...
            username_unique = uniquify( "logs/" + username + "_Task" + str( task ) + "_fisheye_" + str( file_id ) + "_org.json" )
        if space_optimized:
            input_file_name = str(file_id) + "_output.jpg"
            username_unique = uniquify( "logs/" + username + "_Task" + str( task ) + "_fisheye_" + str( file_id ) + "_spc.json" )
